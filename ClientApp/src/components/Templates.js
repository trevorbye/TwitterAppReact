...
export class Templates extends Component {
    ...
    async componentDidMount() {
        ...
        let res = await axios.get(baseUrl + "api/tweet-templates", authHeaders);
    ...
    async saveTemplate() {
        ...
        let authHeaders = await getAuthHeadersSilent(this.props.msalConfig);
        let res = await axios.post(baseUrl + "api/tweet-template", template, authHeaders);
    ...
    renderNewTemplate() {
        ...
        return (
            <SlideDown className={"new-template-slidedown"}>
                ...
                <div className="input-group mb-3">
                    ...
                    <div className="d-flex w-100 justify-content-between">
                            <span>
                                        <button type="button" className="btn btn-primary btn-sm" onClick={() => this.saveTemplate(this.state)}>Save</button>
                            </span>
                        </div>
                </div>
            </SlideDown>
